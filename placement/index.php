...
<body>
    <section class="header">
        ...
        <div class="text-box">
            ...
            <a href="assets/php/Account_Credentials/Student_Login.php"class="student-btn">STUDENT Login</a>
            <a href="assets/php/Account_Credentials/drive_status.php"class="student-btn">Placement Status</a>
        </div>
        <div>
            <?php
            ...
            if(mysqli_num_rows(mysqli_query($con,$check))>0){
                ...
                echo "<h4?> Company ".$company['name'];
                echo "is hiring!";
                echo " Package " .$company['package'];
                echo ", Job Location " .$company['job_location'];
                echo "</h4>";
            }
            ?>
        </div>
